...
> **Terminal and a browser**, is what a web developer really need to start on a creative journey.

### My currenly prefered dev-stack
...
### List of More Tech Stuff

My "too old for this tech" list, or "I forgot how that thing was called" list , if you will.
...
"Code Editors": ["Adminer", "Adobe Dreamweaver", "Aptana", "Atom", "Brackets","Coffeecup HTML Editor", "Eclipse", "Nano", "NetBeans", "Notepad++","PHPStorm", "SQuirreL SQL", "Sequel Pro", "Sublime text", "TablePlus","TextMate", "VSCode", "Vim", "WebStorm", "pgAdmin", "phpMyAdmin"]
"Communication": ["Discord", "Gmail", "Google Meet", "Hey", "Skype", "Slack", "Telegram","Whatsapp", "Zoom"]
"Databases": ["Google Spreadsheet", "MySQL", "Postgres", "Redis", "SQLite"]
...
"Graphic Design": [["Adobe", ["Photoshop", "Illustrator", "InDesign"]], "Figma", "Gimp","Pixelmator", "Sketch"]
"Javascript Libraries": ["RTLCSS", "date-fn", "jQuery", "lodash", "underscore"]
"Language Managers": ["asdf", "fnm", "nvm", "pipenv", "rbenv", "rvm", "virtualenv"]
...
"Operation Systems": ["CentOS", "Debian", "NixOS", "Ubuntu desktop && server", "Windows 98 to XP","macOS"]
"Package Managers": ["Brew", "Bundler", "Composer", "apt", "dpkg", "gem", "mas", "nix", "npm","pip", "pnpm", "rpm", "yarn"]
"Platforms": ["Drupal", "Eleventy", "Ghost", "Jekyll", "Joomla", "Magento", "Middleman","Shopify", "WordPress"]
...
"Tests": ["Bruno", "Chrome Devtools", "Cucumber", "Cypress", "Firebug", "Jasmine","Jest", "Minitest", "Node", "PHPUnit", "Postman", "Puppeteer", "RSpec","Selenium", "Xdebug"]
...
The list is still in active shaping and adjusting, might build a script to maintain it 🤞.
